<?php $__env->startSection('title', 'Services — StarCurrency'); ?>
        ...
        <div class="row g-4">
            <div class="col-lg-4">
                <div class="feature-card d-flex flex-column">
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="btn btn-outline-ivory mt-auto">Get started</a>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="feature-card d-flex flex-column" style="border-color: var(--sc-border-strong);">
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="btn btn-gold mt-auto">Talk to sales</a>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="feature-card d-flex flex-column">
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="btn btn-outline-ivory mt-auto">Contact us</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\starcurrecy\resources\views/home/services.blade.php ENDPATH**/ ?>